...
void SEASON3B::CSystemMenuMsgBox::SetButtonInfo()
{
	...
	x = GetPos().x + msgboxhalfwidth - btnhalfwidth;
	y = GetPos().y + 23;
	m_BtnGameOver.SetInfo(CNewUIMessageBoxMng::IMAGE_MSGBOX_BTN_EMPTY, x - 40, y + 30, width - 20, height, CNewUIMessageBoxButton::MSGBOX_BTN_SIZE_EMPTY);
	m_BtnGameOver.SetText(GlobalText[381]);

	y += 30.f;	
	m_BtnChooseServer.SetInfo(CNewUIMessageBoxMng::IMAGE_MSGBOX_BTN_EMPTY, x - 40, y + 60, width - 20, height, CNewUIMessageBoxButton::MSGBOX_BTN_SIZE_EMPTY);
	m_BtnChooseServer.SetText(GlobalText[382]);

	y += 30.f;	
	m_BtnChooseCharacter.SetInfo(CNewUIMessageBoxMng::IMAGE_MSGBOX_BTN_EMPTY, x + 60, y - 30, width - 20, height, CNewUIMessageBoxButton::MSGBOX_BTN_SIZE_EMPTY);
	m_BtnChooseCharacter.SetText(GlobalText[383]);

	y += 30.f;
	m_BtnOption.SetInfo(CNewUIMessageBoxMng::IMAGE_MSGBOX_BTN_EMPTY, x + 60, y, width - 20, height, CNewUIMessageBoxButton::MSGBOX_BTN_SIZE_EMPTY);
	m_BtnOption.SetText(GlobalText[385]);

	y += 30.f;
	m_BtnCancel.SetInfo(CNewUIMessageBoxMng::IMAGE_MSGBOX_BTN_EMPTY, x + 5, y + 17, width - 15, height - 5, CNewUIMessageBoxButton::MSGBOX_BTN_SIZE_EMPTY);
